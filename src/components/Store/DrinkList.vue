<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>饮料管理</el-breadcrumb-item>
    </el-breadcrumb>
    <el-divider></el-divider>
    <el-row>
      <el-col :span="14"><h2>饮料信息：</h2></el-col>
      <el-col :span="10">
        <el-button type="primary" icon="el-icon-refresh-right" @click="refresh"></el-button>
        <el-button type="info">
          <a href="http://localhost:8081/system/getstroeimporttemplate" target="_blank"
        ...
        <el-upload
          ...
          <el-button type="primary">使用Excel导入库存数据</el-button>
        </el-upload>
        ...
        <el-button type="danger" @click="changeDeleteState" v-else>批量删除饮料</el-button>
      </el-col>
    </el-row>
    <el-card>
      <el-table :data="queryInfo.list" border stripe style="font-size: 16px;align-content:center;">
        ...
        <el-table-column label="饮料名" prop="mname"></el-table-column>
        <el-table-column label="剩余数量">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.stroenumber<5" effect="dark" type="danger">
              {{ scope.row.stroenumber }}/{{ scope.row.unit }}
            </el-tag>
            <el-tag v-else effect="dark" type="warning">{{ scope.row.stroenumber }}/{{ scope.row.unit }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column label="存储时间" prop="stroetime"></el-table-column>
        <el-table-column label="所属类别" prop="mtypename"></el-table-column>
        <el-table-column label="存储人"></el-table-column>
